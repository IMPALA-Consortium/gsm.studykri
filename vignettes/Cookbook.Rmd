...
Next we transform the data to return the cumulated event counts on study-level by study month. 
Date normalization is now done at the input level, so Transform_CumCount performs pure aggregation.
...
Analyze_StudyKRI_PredictBounds calculates upper and lower confidence intervals of the study metrics KRI using a bootstrap technique.
